...
- **[NIST Atomic Spectra Database](https://physics.nist.gov/PhysRefData/ASD/lines_form.html)**                          
  ...
  **Dataset used in UTMF v5.1 configuration:**                                                                        
- `NIST_elements` [Download](https://github.com/Jedi-Markus-Strive/UTMF-v5.1-Coherence/raw/refs/heads/master/downloads/NIST_elements.zip)** (8.5MB) (Complete dataset as used in UTMF v5.1, unzip and use the CSV's 57.5MB) for UTMF analysis.)
---
